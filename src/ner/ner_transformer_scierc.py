...
def make_tag_lookup_table():
    iob_labels = ["B", "I"]
    # ner_labels = ["Task", "Method", "Metric", "Material", "OtherScientificTerm", "Generic"]
    ner_labels = ["Task", "Method", "Material"]
...
train_data = tf.data.TextLineDataset("./data/scierc_train.txt")
val_data = tf.data.TextLineDataset("./data/scierc_test.txt")
